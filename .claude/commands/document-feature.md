...
1. **Glob search** for files whose path or name contains the feature slug or class name.
2. **Grep** for the feature class name, primary export name, or key function names across `.ts`, `.tsx`, `.js`, `.jsx`, `.py`, `.rb`, `.go` files.
3. **Read** the top matches — prioritise:
